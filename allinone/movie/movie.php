...
<?php $image_base_url = 'https://image.tmdb.org/t/p/w500/'; ?>
  ...
  <button id="btn" class="btn btn-outline-danger" type="submit"><a href="">HOME</a> </button>
  </span>
  ...
  <form method="post" class="d-flex" >
        ...
        <button id="search_button" class="btn btn-outline" name="submit" type="submit" value="redirect" >Search</button>
      </form>
  </div>
